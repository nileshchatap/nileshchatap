...
const colors = ["from-primary to-primary/60", "from-accent to-accent/60", "from-primary to-accent", "from-accent to-primary/60"];
    ...
    <section id="experience" className="py-24 section-gradient">
      <div className="container mx-auto px-6">
        <motion.div className="flex items-center gap-3 mb-12" initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Experience</h2>
        </motion.div>
